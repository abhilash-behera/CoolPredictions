...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String shareBodyText = "This App Has Helped me win lot of money.\n" +
                        ...
                        "Download it here; \n" +
                        "https://play.google.com/store/apps/details?id=com.cool.predictions\n";
                sharingIntent.putExtra(Intent.EXTRA_SUBJECT,"Cool Predictions");
                sharingIntent.putExtra(Intent.EXTRA_TEXT, shareBodyText);
                startActivity(Intent.createChooser(sharingIntent, "Share Cool Predictions app With Friends"));
        ...
        String htmlcode = "" +
                ...
                "<head>" +
                "<body>" +
                "<b>Cool Predictions is an App made by a team of Bet Gurus that are always Right.<br /><br />" +
    ...
    private void showFbBannerAd() {
        ...
        try{
            bannerAdView = new AdView(AboutActivity.this, getResources().getString(R.string.fb_about_banner), com.facebook.ads.AdSize.BANNER_HEIGHT_50);
